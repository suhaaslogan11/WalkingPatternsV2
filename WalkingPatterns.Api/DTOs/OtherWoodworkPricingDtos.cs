...
public class OtherWoodworkItemRequest
{
    ...
    public List<OtherWoodworkAdditionalItemRequest> AdditionalItems { get; set; } = new();
    public string? UtilityNameOld { get; set; }
}

public class OtherWoodworkAdditionalItemRequest
{
...
public class OtherWoodworkItemResponse
{
    public int Id { get; set; }
    public string Source { get; set; } = "OtherWoodwork";
