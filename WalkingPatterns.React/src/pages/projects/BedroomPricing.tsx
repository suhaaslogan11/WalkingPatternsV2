...
function BedroomPricingPage() {
    ...
    return <div className="container mt-5">
        <div className="d-flex justify-content-between align-items-center mb-4"><h2>Bedroom Pricing</h2><button className="btn btn-secondary" onClick={() => navigate(`/projects/${parsedProjectId}`)}>Back to Project</button></div>
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
            <div className="card shadow mb-4"><div className="card-body"><div className="row g-3">
            ...
            <button type="submit" className="btn btn-primary">Calculate & Save Bedroom Item</button>
        </form>
    </div>;
}
